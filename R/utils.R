...
# pagedown stuff ----------------------------------------------------------
# 
# fxn_create_yaml_header <- function(title = "Dashboard Report", subtitle = NULL) {
#   if (is.null(subtitle)) {
...
# }
# 
# create_setup_chunk <- function(libraries = c("knitr")) {
#   c(
...
# }
# 
# create_summary_section <- function(dataset_name, num_rows) {
#   c(
#     "# Dashboard Summary",
#     "",
#     sprintf("**Dataset:** %s  ", dataset_name),
#     sprintf("**Rows displayed:** %d", num_rows),
#     ""
#   )
# }
# 
# 
# create_footer <- function(footer_text = "Report generated from Shiny Dashboard") {
#   c(
#     "---",
#     "",
...
# 
# build_report <- function(data, dataset_name, num_rows) {
# 
#   # Calculate summary statistics
#   summary_stats <- data.frame(
#     Metric = c("Rows", "Columns", "Numeric Columns"),
#     Value = c(nrow(data), ncol(data), sum(sapply(data, is.numeric)))
#   )
#   
#   # Get data preview
#   data_preview <- head(data, num_rows)
#   
#   # Build the complete R Markdown content
#   rmd_content <- c(
#     create_yaml_header(),
#     create_setup_chunk(),
#     create_summary_section(dataset_name, num_rows),
#     create_stats_table(summary_stats),
#     create_data_table(data_preview),
#     create_footer()
#   )
#   
#   return(rmd_content)
